...
final Map<String, ResponsiveStylesheet> defaultStylesheet = {
  'h1' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h1,
      displayStyle: DisplayStyle.block
  ),
  'h2' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h2,
      displayStyle: DisplayStyle.block
  ),
  'h3' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h3,
      displayStyle: DisplayStyle.block
  ),
  'h4' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h4,
      displayStyle: DisplayStyle.block
  ),
  'h5' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h5,
      displayStyle: DisplayStyle.block
  ),
  'h6' : ResponsiveStylesheet(
      textStyle: ResponsiveTypography.h6,
      displayStyle: DisplayStyle.block
  ),
  'pre' : ResponsiveStylesheet(
      textStyle: TextStyle(fontFamily: 'monospace')
  ),
  'code' : ResponsiveStylesheet(
      textStyle: TextStyle( color: Colors.white, fontSize: 12, fontFamily: 'monospace'),
  ...
  'mute' : ResponsiveStylesheet(
      opacity: 0.5
  ),
  'u' : ResponsiveStylesheet(
      textStyle: TextStyle(fontStyle: FontStyle.italic, decoration: TextDecoration.underline),
